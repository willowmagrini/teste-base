    ...
    <header x-data="{ menuOpen: false, searchOpen: false }" class="main-header main-header-lateral" :class="{ 'main-header-lateral--menu-open': menuOpen, 'main-header-lateral--search-open': searchOpen }">
        <div class="container container--wide">
			<div class="main-header-lateral__content">
                <button type="button" class="main-header__toggle-menu main-header-lateral__toggle-menu" aria-label="<?= __('Toggle menu visibility', 'teste-base') ?>" @click="menuOpen = !menuOpen">
                ...
                <div class="main-header-lateral__search">
                    <?php get_search_form(); ?>
                    <button type="button" class="main-header__toggle-search main-header-lateral__toggle-search" aria-label="<?= __( 'Toggle search form visibility', 'teste-base' ) ?>" @click="searchOpen = !searchOpen">
                        <iconify-icon icon="fa-solid:search"></iconify-icon>
                    </button>
                </div>

                <?php do_action( 'teste-base/header/menus-end' ); ?>
				</div>
			</div>
        </div>
