...
class API {
    ...
    static function register_routes() {
        register_rest_route('teste-base/v2', '/block_settings', [
            'methods' => 'GET',
            'callback' => 'teste-base\API::rest_block_settings_callback',
            'permission_callback' => 'teste-base\API::rest_permission_to_edit_posts',
        ]);

        register_rest_route('teste-base/v2', '/options', [
            'methods' => 'GET',
            'callback' => 'teste-base\API::rest_options_callback',
            'permission_callback' => 'teste-base\API::rest_permission_to_edit_posts',
        ]);

        register_rest_route('teste-base/v2', '/post_types', [
            'methods' => 'GET',
            'callback' => 'teste-base\API::rest_post_types_callback',
            'permission_callback' => '__return_true',
        ]);

        register_rest_route('teste-base/v2', '/taxonomies/(?P<post_type>[a-zA-Z0-9_-]+)', [
            'methods' => 'GET',
            'callback' => 'teste-base\API::rest_taxonomies_callback',
            'args' => [
                'post_type' => [
                    'required' => true,
        ...
        register_rest_route('teste-base/v2', '/terms/(?P<taxonomy>[a-zA-Z0-9_-]+)', [
            'methods' => 'GET',
            'callback' => 'teste-base\API::rest_terms_callback',
            'args' => [
                'search' => [
                    'type' => 'string',
                    'default' => '',
