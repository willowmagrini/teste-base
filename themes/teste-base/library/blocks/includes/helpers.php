...
function get_used_post_ids () {
    ...
    global $teste-base_blocks_post_ids;

    if ( ! $newspack_blocks_post_id ) {
        $newspack_blocks_post_id = [];
    }

    if ( ! $teste-base_blocks_post_ids ) {
        $teste-base_blocks_post_ids = [];
    }

    $post__not_in = array_merge( $teste-base_blocks_post_ids, array_keys( $newspack_blocks_post_id ) );
...
function mark_post_id_as_used ( int $post_id ) {
    ...
    $teste-base_blocks_post_ids[] = $post_id;
