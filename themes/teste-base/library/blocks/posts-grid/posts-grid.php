...
function get_posts_grid_data ($attributes): \WP_Query {
    $cached_query = get_block_transient('teste-base/posts', $attributes);
    ...
    set_block_transient('teste-base/posts', $attributes, $query);
...
function render_posts_grid_callback ($attributes) {
    ...
    <div class="<?= build_class_list('teste-base-posts-grid-block', $attributes) ?>" style="--grid-columns: <?= $posts_per_row ?>">
