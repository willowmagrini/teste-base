...
const OPTIONS_MAP = {
    'large': { label: _x('Large', 'size', 'teste-base'), icon: LargeIcon },
    'medium': { label: _x('Medium', 'size', 'teste-base'), icon: MediumIcon },
    'small': { label: _x('Small', 'size', 'teste-base'), icon: SmallIcon },
    'x-large': { label: _x('Extra Large', 'size', 'teste-base'), icon: ExtraLargeIcon },
    'x-small': { label: _x('Extra Small', 'size', 'teste-base'), icon: ExtraSmallIcon },
};
...
export function SelectSize ({ label = __('Size', 'teste-base'), options = DEFAULT_OPTIONS, value, onChange }) {
    return (
