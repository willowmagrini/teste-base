...
function register_menus() {
    register_nav_menu( 'main-menu', __( 'Main menu', 'teste-base' ) );
    register_nav_menu( 'social-networks', __( 'Social networks', 'teste-base' ) );
}

add_action( 'init', 'teste-base\\register_menus' );
...
add_filter( 'walker_nav_menu_start_el', 'teste-base\\add_menu_arrow', 10, 4 );
...
add_filter('wp_get_nav_menu_items', 'teste-base\\hide_menu_item_if_logged_in_ethos', 10, 3);
