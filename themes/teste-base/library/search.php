...
// add_filter( 'posts_join', 'teste-base\\join_meta_table' );
...
// add_filter( 'posts_where', 'teste-base\\modify_where_clause' );
...
// add_filter( 'posts_distinct', 'teste-base\\prevent_duplicates' );
...
add_action( 'pre_get_posts', 'teste-base\\post_types_in_search_results' );
