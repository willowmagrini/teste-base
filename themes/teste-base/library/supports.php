...
add_action( 'after_setup_theme', 'teste-base\\theme_supports' );

/**
 * Load the theme textdomain
 */
function theme_setup() {
    load_theme_textdomain( 'teste-base', get_stylesheet_directory() . '/languages' );
}
add_action( 'after_setup_theme', 'teste-base\\theme_setup' );
