...
<header class="post-header container">
    ...
    <div class="post-header__meta container">
        <p class="post-header__date"><?php _e('Published in ', 'teste-base') ?><?= get_the_date() ?></p>
        <?php get_template_part('template-parts/share-links', null, ['link'=>get_the_permalink()]) ?>
    </div>

    <div class="post-header__author container">
        <p class="post-header__author-name"><?php _e('Published by ', 'teste-base') ?><?= get_the_author() ?></p>
    </div>
</header>
